...
| 2024-04 |     SALMONN          |      Tsinghua          | SALMONN: Speech Audio Language Music Open Neural Network | [Paper](https://arxiv.org/pdf/2310.13289.pdf) / [Code](https://github.com/bytedance/SALMONN) / [Demo](https://huggingface.co/spaces/tsinghua-ee/SALMONN-7B-gradio) |
...
| 2023-12 |     LTU-AU           |      MIT               | Joint Audio and Speech Understanding | [Paper](https://arxiv.org/pdf/2311.07919.pdf) / [Code](https://github.com/QwenLM/Qwen-Audio) / [Demo](https://huggingface.co/spaces/yuangongfdu/ltu-2) |
...
| 2023-06 |     AudioPaLM        |      Google            | AudioPaLM: A Large Language Model That Can Speak and Listen | [Paper](https://arxiv.org/pdf/2309.14405v3.pdf) / [Code](https://github.com/YuanGongND/ltu) / [Demo](https://google-research.github.io/seanet/audiopalm/examples/) |
| 2023-05 |     VioLA            |      Microsof          | VioLA: Unified Codec Language Models for Speech Recognition, Synthesis, and Translation | [Paper](https://arxiv.org/pdf/2305.16107.pdf) |
